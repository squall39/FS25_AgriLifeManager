...
changes = [
    ('id="headerContextHelp" text="--" position="340px 8px" size="500px 48px" textSize="11px" textColor="0.72 0.80 0.77 1"', 'id="headerContextHelp" text="--" position="340px 9px" size="640px 44px" textSize="12px" textColor="0.84 0.90 0.88 1"'),
    ('id="headerAccessMode" text="--" position="850px 18px" size="145px 24px" textSize="12px" textBold="true" textAlignment="right" textColor="0.67 0.91 0.45 1"', 'id="headerAccessMode" text="--" position="995px 18px" size="145px 24px" textSize="12px" textBold="true" textAlignment="right" textColor="0.72 0.94 0.50 1"'),
