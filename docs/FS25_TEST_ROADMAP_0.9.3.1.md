# Feuille de route - Phase de test AgriLife Manager 0.9.3.1 TEST
...
- Utiliser la build de référence **0.9.3.1 TEST**.
...
- [ ] Installer uniquement **0.9.3.1 TEST**.
...
> **Correctif 0.9.3.1 :** F01 a été validé sur la 0.9.3.0. Le correctif F02 ne change pas les règles économiques du mode Facile, mais le tutoriel paginé doit être recontrôlé au démarrage. F02 doit être rejoué intégralement avant de poursuivre vers F03.
...
- [ ] sauvegarde fiable ;
- [ ] Atelier 0.9.3.1 fonctionnel sur les quatre familles de matériel ;
...
## N07 - Revalidation 0.9.3.1 en Normal
...
## D08 - Revalidation 0.9.3.1 en Difficile
...
# PHASE 7 - Décision finale 0.9.3.1 TEST
