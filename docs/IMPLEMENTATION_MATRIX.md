...
# AgriLife Manager - matrice d'implémentation 0.9.0.0
...
| Interface de base | INTÉGRÉ / À TESTER | tableau de bord 6 cartes, navigation, onboarding, tutoriel paginé, journal, HUD et actions contextuelles |
| Banque | INTÉGRÉ / À COMPLÉTER | banque/conseiller, crédit, dette héritée, comptes pro/perso, bases comptables/fiscales et restrictions ; plusieurs points avancés de la roadmap restent à écrire |
...
- 27 langues avec 5 011 clés alignées ;
- 115 fichiers Lua dans le package de travail ;
- 91 XML ;
- 103 Lua actifs déclarés ou spécialisés ;
...
L'étape 9 côté écriture ne vaut pas certification finale. Les essais FS25 réels, les finitions historiques des étapes 1 à 3, le multijoueur, les différentes résolutions, plusieurs maps et la préparation d'une version publique stable restent distincts.
