...
| ID | Idée validée | Module | État code | Tutoriel / Assistance | Certification |
|---|---|---|---|---|---|
| DEM-001 | Trois difficultés Facile / Normal / Difficile avec conséquences globales | Démarrage | Intégrée | Oui | À certifier |
| DEM-002 | Onboarding seulement après arrivée réelle sur la map, jamais pendant les vêtements | Démarrage | Intégrée | Oui | À certifier |
| DEM-003 | Capitaux de départ et persistance par carrière | Démarrage | Intégrée | Oui | À certifier |
| DEM-004 | Banque/conseiller obligatoires selon la difficulté | Démarrage / Banque | Intégrée | Oui | À certifier |
| DEM-005 | Permis provisoire Normal, rappels, échéance et sanction personnelle | Démarrage / Carrière | Intégrée | Oui | À certifier |
| DEM-006 | Verrou de conduite Difficile avant permis définitif avec exception examen | Démarrage / Carrière | Intégrée | Oui | À certifier |
| UI-001 | Tableau de bord AgriLife à six modules | Interface | Intégrée | Oui | À certifier |
| UI-002 | Tutoriel de départ harmonieux et complet, actuellement 13 sujets | Interface | Intégrée | Oui | À certifier |
| UI-003 | `Échap > Assistance` aligné sur les mêmes clés l10n que le tutoriel | Interface | Intégrée | Oui | À certifier |
| UI-004 | HUD XP / permis autour du mini-PDA et activités contextualisées | Interface / Carrière | Intégrée | Oui | À certifier |
| BAN-001 | Relation banque + conseiller, accès et profils | Banque | Intégrée | Oui | À certifier |
| BAN-002 | Crédits, taux, garanties, refinancement et capacité réelle | Banque | Intégrée | Oui | À certifier |
| BAN-003 | Comptabilité avancée, fiscalité, amortissements, bilan, CAF et rentabilité | Banque / Économie | Intégrée | Oui | À certifier |
| BAN-004 | Séparation comptes professionnel / personnel et mouvements justifiés | Banque | Intégrée | Oui | À certifier |
| ENT-001 | Entreprise, contrats de travail et organisation durable | Entreprise | Intégrée | Oui | À certifier |
| ENT-002 | Une personne = une tâche réelle, planning et centre d’ordres | Entreprise | Intégrée | Oui | À certifier |
| ENT-003 | Paie unique, charges et intégrations IA / Courseplay / AutoDrive optionnelles | Entreprise | Intégrée | Oui | À certifier |
| ENT-004 | XP salarié, recrutement, incidents et évolution | Entreprise | Intégrée | Oui | À certifier |
| ENT-005 | Réputation de l’exploitation et conséquences inter-modules | Entreprise / Global | Intégrée | Oui | À certifier |
| CAR-001 | XP métier par action et difficulté, sans progression pendant les examens | Carrière | Intégrée | Oui | À certifier |
| CAR-002 | Permis agricole en 10 étapes, historique et persistance | Carrière | Intégrée | Oui | À certifier |
| CAR-003 | Qualifications spécialisées et verrous métier | Carrière | Intégrée | Oui | À certifier |
| ADM-001 | Statut/licence d’exploitation évolutif | Administration | Intégrée | Oui | À certifier |
| ADM-002 | Contrôles administratifs, avertissements, sanctions et récidive | Administration | Intégrée | Oui | À certifier |
| ADM-003 | Assurances, contrats, franchises et obligations | Administration | Intégrée | Oui | À certifier |
| ADM-004 | Huissier / contentieux et régularisation | Administration | Intégrée | Oui | À certifier |
| MKT-001 | Contrats commerciaux, coopératives, négociation et notation | Contrats & Marchés | Intégrée | Oui | À certifier |
| MKT-002 | Marchés dynamiques universels, maps vanilla/modmaps et multifruits | Contrats & Marchés | Intégrée | Oui | À certifier |
| MKT-003 | Marché neuf / occasion et inspection avant achat | Contrats & Marchés | Intégrée | Oui | À certifier |
| MKT-004 | Consommables, palettes, big bags et intrants dynamiques | Contrats & Marchés | Intégrée | Oui | À certifier |
| MKT-005 | Carburants et énergie dynamiques | Contrats & Marchés | Intégrée | Oui | À certifier |
| MKT-006 | Foncier / champs dynamiques | Contrats & Marchés | Intégrée | Oui | À certifier |
| MKT-007 | Location dynamique matériel, champs et productions | Contrats & Marchés | Intégrée | Oui | À certifier |
| MKT-008 | Productions/usines reliées à l’économie commune | Contrats & Marchés | Intégrée | Oui | À certifier |
| MKT-009 | Precision Farming / Soil Fertilizer en enrichissements optionnels | Compatibilité | Intégrée | Oui | À certifier |
| WRK-001 | Architecture mécanique par composants, usure, stress et vieillissement | Atelier | Intégrée | Oui | À certifier |
| WRK-002 | Pannes fonctionnelles pouvant réduire les performances ou immobiliser réellement | Atelier | Intégrée | Oui | À certifier |
| WRK-003 | Diagnostic, devis et historique technique | Atelier | Intégrée | Oui | À certifier |
| WRK-004 | Pièces détachées, qualités, marché et délais | Atelier | Intégrée | Oui | À certifier |
...
| FIN-004 | Multijoueur par ferme, serveur autoritaire et isolation | Finalisation | Désactivée | N/A | À certifier avant activation |
| PROC-001 | Toute idée validée synchronisée avec roadmap, tutoriel/Assistance si joueur, GitHub et build de référence | Méthode projet | Intégrée | N/A | Contrôle continu |

## Règle d’utilisation du registre
